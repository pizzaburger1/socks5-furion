...
from furion.socks5 import *
from furion.ping import PingHandler
from furion.dns import *
from furion.rpc import *
from furion.config import FurionConfig as cfg
from furion.helpers import *
from furion.servers import *
...
def main():
    ...
    try:
        ...
        cfg.local_port = int(os.environ.get('PORT', cfg.local_port))
